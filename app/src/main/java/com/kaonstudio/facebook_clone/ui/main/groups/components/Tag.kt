...
sealed class TagItem(val icon: Int, val title: String) {
    object Groups : TagItem(R.drawable.groups_icon, "Your Groups")
    object Rooms : TagItem(R.drawable.room_icon, "Rooms & Chats")
    object Discover : TagItem(R.drawable.discover_icon, "Discover")
    object Invites : TagItem(R.drawable.invite_icon, "Invites")
}